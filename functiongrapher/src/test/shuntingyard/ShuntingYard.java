 ...
 */
package test.shuntingyard;

import test.function.Function;
import test.operator.Operator;
import test.tokenizer.OperatorToken;
import test.tokenizer.Token;
import test.tokenizer.Tokenizer;
...
public class ShuntingYard {
     ...
     * @return a {@link test.tokenizer.Token} array containing the result
     */
