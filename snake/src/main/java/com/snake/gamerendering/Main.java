...
import com.snake.gamelogic.Directions;
...
public class Main extends Application {
    ...
    private final NewImage snakePart = new NewImage(new Image("file:src/main/java/com/snake/assets/snakepart_01.png"),
            "snakePart");
    private final NewImage apple = new NewImage(new Image("file:src/main/java/com/snake/assets/apple.png"), "apple");
    private final NewImage killer = new NewImage(new Image("file:src/main/java/com/snake/assets/killer.png"), "killer");
    private final NewImage poison = new NewImage(new Image("file:src/main/java/com/snake/assets/poison.png"), "poison");
    private final NewImage star = new NewImage(new Image("file:src/main/java/com/snake/assets/star.png"), "star");
    private final NewImage slowerTimer = new NewImage(new Image("file:src/main/java/com/snake/assets/slowertimer.png"),
            "slowerTimer");
        ...
        for (Item item : items) {
            ...
            switch (item.name()) {
                ...
                case "SlowerTimer":
                    ...
                    drawer.drawText(gameLogic.getZoomTime() + "", x + CELL_SIZE / 2, y + CELL_SIZE / 2,
                            gameLogic.getZoomValue());
                    break;
                default:
